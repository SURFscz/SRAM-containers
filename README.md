...
This repository provides images for all separate containers that comprise the SURF Research Access Management platform.  Together with the deploy scripts in SURFscz/SRAM-deploy, this allows you to deploy a SURF Research Access Management clone in a (plain docker) container environment.
